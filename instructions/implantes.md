...
* **Validación:** * Si el valor del mercado es **0 o negativo**, mostrar error en rojo: "VALORACIÓN FISCAL NULA".
    * **Bloqueo:** El botón de "Registrar" debe estar `disabled` si el modelo del implante tiene menos de 5 caracteres.
* **Éxito:** Al finalizar, mostrar un **Toast** o mensaje en verde: *"ACTIVO REGISTRADO Y TASADO"* y añadirlo a la lista.
